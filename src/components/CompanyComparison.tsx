 ...
 * MeDo Prompt: "Add a company comparison tool where I can compare mining 
 * companies side-by-side across metrics like production volume, reserve 
 * estimates, ESG scores, and market cap. Include a search bar and 
 * sortable tables."
 */
