 ...
 * MeDo Prompt: "Use a dark theme with teal and gold accents. Add a sidebar 
 * navigation with: Dashboard, Price Tracker, Supply Chain Map, Risk Analysis, 
 * Reserves, Company Compare, ESG. Make it responsive. Include summary cards 
 * at the top with key metrics."
 */
      ...
      >
        ...
        <footer className="mt-6 rounded-xl p-4" style={{ background: '#0d1520', border: '1px solid #1e293b' }}>
          ...
          <p className="text-xs mt-3" style={{ color: '#334155' }}>
            © MineScope · Built with MeDo · Data updated: 2025-01-15
          </p>
        </footer>
      </main>
    </div>
